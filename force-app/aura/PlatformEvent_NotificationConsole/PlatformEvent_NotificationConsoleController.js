({
    ...
    init: function (component, event, helper) {
        console.log('PlatformEvent_NotificationConsoleController > init');
        ...
        const errorHandler = function (message) {
          console.error('PlatformEvent_NotificationConsoleController > error ', JSON.stringify(message));
        };
    ...
    navigateToRecord : function(component, event, helper) {
        ...
        console.log('PlatformEvent_NotificationConsoleController > navigateToRecord - recordID: ' + recordID);
    ...
    navigateToRecordFromLink : function(component, event, helper) {
        ...
        console.log('PlatformEvent_NotificationConsoleController > navigateToRecordFromLink - recordID: ' + recordID);
